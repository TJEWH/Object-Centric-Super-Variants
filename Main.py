...
#variant_2 = IED.extract_lanes(variant_layouting[ocel_order_process.variants[4]])
...
variant_3 = IED.extract_lanes(variant_layouting[ocel_running_example.variants[1]])
...
#summarizations_variant_3 = BAPO.get_all_summarizations(variant_3, True)
