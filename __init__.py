...
super_variant_14, cost = BVS.join_super_variants(summarizations[10], summarizations[11], True)
super_variant_12, cost = BVS.join_super_variants(summarizations[1], summarizations[2], True)
