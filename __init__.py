...
if(MODE == 1):
    ...
    super_variant, cost = IEVS.join_super_variants(super_variant, summarizations[3], True, False)
    super_variant, cost = IEVS.join_super_variants(super_variant, summarizations[4], True, False)
